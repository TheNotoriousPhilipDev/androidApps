...
//DATOS
    ...
    private Multa consultar() throws JSONException, IOException, JSONException {
...
//DATOS
        ...
        if (json != null) { // si la respuesta no es vacia
            ...
            if (json_array.length() > 0) { // si lo encontrado tiene al menos un registro
                Multa multa = new Multa(json_array.getJSONObject(0));// instanciamos la clase multa para obtener los datos jso
